 ...
 *
 * <p>Metadata is parsed once and shared by child {@link Variant} cursors.
 *
 * @opensearch.internal
 */
@InternalApi
public final class VariantMetadata {
     ...
     * parse and nothing stored per document beyond the ordinals themselves. The writer earns this by assigning field ids
     * from the final sorted dictionary before encoding the value.
     *
