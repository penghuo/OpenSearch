...
public final class VariantJson {
    ...
    private static void encodeNumber(XContentParser parser, VariantBuilder builder) throws IOException {
        switch (parser.numberType()) {
            ...
            case BIG_INTEGER:
                ...
                break;
            case BIG_DECIMAL: {
                BigDecimal decimal = toBigDecimal(parser.numberValue(), parser.text());
                builder.appendBigDecimal(decimal);
                break;
            }
            default:
    ...
    private static BigDecimal toBigDecimal(Number number, String text) {
