...
public class TransportClient implements Closeable {
    ...
    public TransportClient(Channel channel, TransportResponseHandler handler) {
        this.channel = JavaUtils.checkNotNull(channel);
        this.handler = JavaUtils.checkNotNull(handler);
        this.timedOut = false;
    }
    ...
    public void setClientId(String id) {
        assert clientId == null : ("Client ID has already been set.");
        this.clientId = id;
    }
    ...
    public void sendMergedBlockMetaReq(
        ...
        handler.addRpcRequest(requestId, callback);
        RpcChannelListener listener = new RpcChannelListener(requestId, callback);
        channel.writeAndFlush(new MergedBlockMetaRequest(requestId, appId, shuffleId, shuffleMergeId, reduceId)).addListener(listener);
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("remoteAddress", channel.remoteAddress())
